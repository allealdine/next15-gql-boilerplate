 ...
 * });
 */
export function useInWishlistQuery(baseOptions: Apollo.QueryHookOptions<InWishlistQuery, InWishlistQueryVariables> & ({ variables: InWishlistQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useInWishlistSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<InWishlistQuery, InWishlistQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
