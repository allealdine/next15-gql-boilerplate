 ...
 * });
 */
export function useStoreNoticesQuery(baseOptions: Apollo.QueryHookOptions<StoreNoticesQuery, StoreNoticesQueryVariables> & ({ variables: StoreNoticesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useStoreNoticesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<StoreNoticesQuery, StoreNoticesQueryVariables>) {
