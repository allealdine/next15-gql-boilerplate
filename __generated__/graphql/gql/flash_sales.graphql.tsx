...
export function useFlashSalesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FlashSalesQuery, FlashSalesQueryVariables>) {
...
export function useFlashSaleSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FlashSaleQuery, FlashSaleQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useFlashSaleProductBySlugQuery(baseOptions: Apollo.QueryHookOptions<FlashSaleProductBySlugQuery, FlashSaleProductBySlugQueryVariables> & ({ variables: FlashSaleProductBySlugQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useFlashSaleProductBySlugSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FlashSaleProductBySlugQuery, FlashSaleProductBySlugQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
